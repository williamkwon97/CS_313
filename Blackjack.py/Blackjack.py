...
# Description: Simulating Blackjack
...
class Player(object):
    ...
    def __str__(self):
        ...
        for card in self.cards:
            hand = appendtohand + " " + str(card)
        pointstostr = " - " + str(points) + " points."
        return appendtohand + pointstostr
...
class Blackjack(object):
    ...
    def play(self):
        ...
        for i in range(self.num_players):
            if (self. player_list[i].has_blackjack() or dealer_points > 21):
                print('Player wins')
